...
namespace Microsoft.DotNet.Cli.MSBuild.Tests
{
    ...
    {
        const string ExpectedPrefix = "/m /v:m /restore /t:pack";
        const string ExpectedNoBuildPrefix = "/m /v:m /t:pack";
        ...
        public void MsbuildInvocationIsCorrect(string[] args, string expectedAdditionalArgs)
        {
            ...
            string.Join(" ", command.Arguments).Should().Be($"{expectedPrefix}{expectedAdditionalArgs}");
        }
    }
}
